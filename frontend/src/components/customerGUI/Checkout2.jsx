        ...
        <div className="flex flex-col min-h-screen">
            ...
            <main className="flex-grow">
                ...
                {isPopupOpen && (
                    <div className="popup" onClick={closePopup}>
                        <div
                            className=" flex flex-col w-[500px] h-[600px]"
                            onClick={(e) => e.stopPropagation()}
                        >
                            <h2
                                className="font-bold text-red-600 text-lg bg-[#F3F6F8] w-[500px]  h-[40px] pt-2 rounded-t-lg shadow-lg text-center"
                            >
                                Chọn Voucher
                            </h2>
                            {/* Container cuộn */}
                            <div
                                className="flex-1 overflow-y-auto bg-white w-[500px] pl-10"
                            >
                                <Voucher
                                    buyList={productList}
