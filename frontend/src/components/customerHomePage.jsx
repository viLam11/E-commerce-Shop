...
class LogIn extends PageComponent {
    ...
    handleSubmit(event) {
        ...
        const { users,doneLog } = this.props;
    
        // Add your login logic here, for example:
        if (email && password) {
            console.log("Email:", email);
            console.log("Password:", password);
            const checkExistAccount = users ? users.find(item => item.email === email) : null;
            if (!checkExistAccount) {
                alert('Email của bạn đã sai. Vui lòng nhập lại!');
                throw new Error('Lỗi đăng nhập');
            } else if (checkExistAccount.upassword !== password) {
                alert('Bạn nhập sai mật khẩu!');
                throw new Error('Sai mật khẩu');
            } else {
                doneLog(checkExistAccount.uid); // Call doneLog from the parent class
            }
        } else {
            ...
            <div className="login-container">
                ...
                <form onSubmit={this.handleSubmit}>
                    ...
                    <div className="links">
                        ...
                        <p>Bạn là chủ shop? <a href="#">Kênh người bán</a></p>
                    </div>
                </form>
            </div>
        );
        ...
        return (
            <div className="acc-container">
                <div className="acc-breadcrumb">
                    <a onClick={() => navigateToHomePage()}>Home</a>/<a><b>Account</b></a>
                </div>
